...
def wind_vector():
    ...
    global WindVector_csv
    WindVector_csv = second_wind_vector.text
    WindVector_csv = WindVector_csv.strip()
    print(type(WindVector_csv))
    print(WindVector_csv)
...
def wind_power():
    ...
    global WindPower_csv
    WindPower_csv = second_wind_power.text
...
job()
csv_path = r"C:\Users\susi0\git-traning\weather\data\weather.csv"
header = ['place','mon','day','yobi','h','tmp','rain','vec','pow']
weather_csv = ["大和市桜が丘",month,day,yobi,6,temp_csv,rain_csv,WindVector_csv,WindPower_csv]
